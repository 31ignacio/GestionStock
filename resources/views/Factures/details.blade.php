      ...
      <div class="row">
        <div class="col-12">
          <div class="callout callout-info">
            ...
            <b>Cette page fournit une vue détaillée de la facture du client, présentant les informations essentielles telles que les produits/services achetés, les quantités, les tarifs unitaires, et le montant total. Elle offre une vision claire et exhaustive des transactions effectuées par le client.</b>
          </div>
